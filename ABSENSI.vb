...
Public Class ABSENSI
    ...
    Private Sub ABSENSI_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ElseIf "08.16.00" < DASHBOARD.SS4.Text > "08.01.00" Then
            TextBox3.Text = "TERLAMBAT 15 MENIT"

        ElseIf "08.32.00" < DASHBOARD.SS4.Text > "08.17.00" Then
            TextBox3.Text = "TERLAMBAT 30 MENIT"

        ElseIf "08.48.00" < DASHBOARD.SS4.Text > "08.33.00" Then
            TextBox3.Text = "TERLAMBAT 45 MENIT"

        ElseIf "09.29.00" < DASHBOARD.SS4.Text > "08.49.00" Then
            TextBox3.Text = "TERLAMBAT 1 JAM"

        ElseIf DASHBOARD.SS4.Text > "09.30.00" Then
            TextBox3.Text = "ALPA"
        End If
    End Sub
End Class